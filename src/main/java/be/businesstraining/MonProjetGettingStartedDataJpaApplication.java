...
public class MonProjetGettingStartedDataJpaApplication {
	...
	private static final Logger log = LoggerFactory.getLogger(MonProjetGettingStartedDataJpaApplication.class);
	...
	public CommandLineRunner demo(CustomerRepository repository) {
		return (args) -> {
			...
			// SE esta usando para la creacion de clientes el patron Builder
